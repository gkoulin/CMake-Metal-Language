...
# This file is used by EnableLanguage in cmGlobalGenerator to determine that the selected C++
# compiler can actually compile and link the most basic of programs. If not, a fatal error is set
# and cmake stops processing commands and will not generate any makefiles or projects.
...
if(NOT CMAKE_Metal_COMPILER_WORKS)
    ...
    # Unlike C and CXX we do not yet detect any information about the Metal ABI. However, one of the
    ...
    set(CMAKE_Metal_IMPLICIT_INCLUDE_DIRECTORIES
        "${_CMAKE_Metal_IMPLICIT_INCLUDE_DIRECTORIES_INIT}")
