...
if("${CMAKE_GENERATOR}" MATCHES "^Ninja")
    ...
    message(FATAL_ERROR "Metal language not supported by \"${CMAKE_GENERATOR}\" generator")
endif()

# Find additional tools
get_filename_component(_metal_directory ${CMAKE_Metal_COMPILER} DIRECTORY)
find_program(CMAKE_Metallib_COMPILER metallib PATHS ${_metal_directory} REQUIRED)
find_program(CMAKE_Metal_AR metal-ar PATHS ${_metal_directory} REQUIRED)
